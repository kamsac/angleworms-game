...
import SpritesList from '../../types/sprites-list.type';
import PlayerHeadPrimitiveSpriteMaker from './player-head-primitive-sprite-maker';
import PlayerTailPrimitiveSpriteMaker from './player-tail-primitive-sprite-maker';
import UnknownPrimitiveSpriteMaker from './unknown-primitive-sprite-maker';
